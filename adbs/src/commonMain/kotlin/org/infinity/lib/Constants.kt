...
val BS_DATES: Array<Array<Int>> = arrayOf(
    ...
    arrayOf(2087, 31, 31, 32, 31, 31, 31, 30, 30, 30, 30, 30, 30),
    ...
    arrayOf(2091, 31, 31, 32, 31, 31, 31, 30, 30, 29, 30, 30, 30),
    arrayOf(2092, 30, 31, 32, 32, 31, 30, 30, 30, 29, 30, 30, 30),
    arrayOf(2093, 30, 32, 31, 32, 31, 30, 30, 30, 29, 30, 30, 30),
    arrayOf(2094, 31, 31, 32, 31, 31, 30, 30, 30, 29, 30, 30, 30),
    arrayOf(2095, 31, 31, 32, 31, 31, 31, 30, 29, 30, 30, 30, 30),
    arrayOf(2096, 30, 31, 32, 32, 31, 30, 30, 29, 30, 29, 30, 30),
    arrayOf(2097, 31, 32, 31, 31, 31, 30, 30, 30, 29, 30, 30, 30),
    arrayOf(2098, 31, 31, 32, 31, 31, 31, 29, 30, 29, 30, 29, 31),
    arrayOf(2099, 31, 31, 32, 31, 31, 31, 30, 29, 29, 30, 30, 30),
    arrayOf(2100, 31, 32, 31, 32, 31, 30, 30, 30, 29, 29, 30, 31)
)